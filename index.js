...
import { ShadowCoreJadiBot } from './plugins/jadibot-serbot.js'
...
say(`Developed By • The-Shadow'core`, {
font: 'console',
align: 'center',
colors: ['blueBright']
})
...
if (connection == 'open') {
console.log(chalk.bold.green('\n⛩️ sukuna bot Conectado con éxito'))
}
...
ShadowCoreJadiBot({pathShadowCoreJadiBot: botPath, m: null, conn, args: '', usedPrefix: '/', command: 'serbot'})
}
}
}
}
